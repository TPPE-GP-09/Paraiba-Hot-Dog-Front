...
function CardProdutoAdm({
  ...
  return (
    <article className="group relative flex w-full flex-col overflow-hidden rounded-[5px] bg-[#222] text-left shadow-[0_12px_24px_rgba(0,0,0,0.28)] outline-none transition-transform hover:-translate-y-0.5 min-[640px]:h-44 min-[640px]:flex-row">
